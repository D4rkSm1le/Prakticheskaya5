...
namespace Tortik
{
    internal class Program
    {
        static void Main()
        {
            ...
            FormaTorta.AddItem(3, "Дота - 1000", 1000, FormaTorta.HideMenu);
            ...
            SizeTorta.AddItem(0, "Обычный - 1300", 1300, SizeTorta.HideMenu);
            SizeTorta.AddItem(1, "Дуо торт - 800", 800, SizeTorta.HideMenu);
            SizeTorta.AddItem(2, "Не большой торт(чисто на др) - 1800", 1800, SizeTorta.HideMenu);
            SizeTorta.AddItem(3, "ОГРОМНЫЙ ТОРТ!!!! - 2500", 2500, SizeTorta.HideMenu);
            ...
            TasteTorta.AddItem(2, "Банановый - 500", 500, TasteTorta.HideMenu);
            TasteTorta.AddItem(3, "Яблочный - 400", 400, TasteTorta.HideMenu);
            TasteTorta.prices = new int[] { 300, 350, 500, 400 };
            TasteTorta.PlayMenu = mainMenu;

            Menu InsideTorta = new Menu("~>");
            InsideTorta.Zagolovok = "Начинка торта";
            ...
            InsideTorta.AddItem(2, "Банановый - 400", 400, InsideTorta.HideMenu);
            InsideTorta.AddItem(3, "Яблочный - 500", 500, InsideTorta.HideMenu);
            ...
            CountYarys.AddItem(0, "Один ярус - 300", 300, CountYarys.HideMenu);
            ...
            Dekor.AddItem(0, "Чисто ягодок добавить - 500", 500, Dekor.HideMenu);
            Dekor.AddItem(1, "Посыпка со звёздами - 300", 300, Dekor.HideMenu);
            Dekor.AddItem(2, "Сладости - 400", 400, Dekor.HideMenu);
            Dekor.AddItem(3, "Без декора", 0, Dekor.HideMenu);

            Dekor.PlayMenu = mainMenu;

            mainMenu.Zagolovok = "  Жёская торталетка от D4rkSm1le";
            mainMenu.AddItem(0, "Форма Торта", 0, FormaTorta.ShowMenu);
            mainMenu.AddItem(1, "Размер Торта", 0, SizeTorta.ShowMenu);
            mainMenu.AddItem(2, "Вкус Коржей", 0, TasteTorta.ShowMenu);
            mainMenu.AddItem(3, "Начинка торта", 0, InsideTorta.ShowMenu);
        ...
        static void Exit()
        {
            ...
            string price = "Чек заказа: " + Global.Price;
            if (File.Exists(path))
            {
    ...
    public class Menu
    {
        ...
        public Menu(string arrow = "->")
        {
            ...
            this.Arrow = arrow;
            ArrowColour = ConsoleColor.White;
